...
async function recommendPaperForPublication(id) {
    return request(`/papers/${id}/recommend`, {
        method: 'POST'
    });
}
...
async function getMessages(contactId) {
    return request(`/chat/messages?contact_id=${contactId}`);
}
async function sendMessage(receiverId, content, attachmentUrl, attachmentName, attachmentType, attachmentSize, replyToMessageId, isForwarded) {
...
async function createNotification(userId, message, paperId) {
    return request('/notifications', {
        method: 'POST',
        body: JSON.stringify({
            user_id: userId,
...
function AuthProvider({ children }) {
    ...
    const logout = async ()=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signOut"])();
            setUser(null);
            router.push('/login');
        } catch (error) {
...
function ThemeProvider({ children }) {
    const { user, refreshUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const toggleDarkMode = async ()=>{
        ...
        try {
            ...
            if (user) {
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateProfile"])({
                    preferences: {
                        ...user.preferences,
                        darkMode: newMode
                    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__99992ab4._.js.map