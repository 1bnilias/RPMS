...
function AuthProvider({ children }) {
    ...
    const refreshUser = async ()=>{
        try {
            const userData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCurrentUser"])();
            setUser(userData);
        } catch (error) {
    ...
    const logout = async ()=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signOut"])();
            setUser(null);
            router.push('/login');
        } catch (error) {
...
function ThemeProvider({ children }) {
    _s();
    const { user, refreshUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const toggleDarkMode = async ()=>{
        ...
        try {
            ...
            if (user) {
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateProfile"])({
                    preferences: {
                        ...user.preferences,
                        darkMode: newMode
                    }
...
_s(ThemeProvider, "YlKOBO+m7C+WlPwczc+ZkzGx154=", false, function() {
    return [
...
//# sourceMappingURL=_9347c4b9._.js.map