    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading editor panel...</p>
        </div>
      </div>
    )
  }
            ...
            <div className="p-6">
              {papers.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600">No papers assigned for review</p>
                </div>
              ) : (
                      ...
                      <div key={paper.id} className="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                        ...
                        {existingReview && (
                          <div className="mt-3 p-3 bg-gray-50 rounded">
                            <div className="flex justify-between items-start mb-2">
                              <div>
                                <p className="text-sm font-medium">Rating: {existingReview.rating}/5</p>
